...
## 🎓 Education
- **한림대학교 소프트웨어융합학부 빅데이터 전공 (3.0/4.5)** — 2025.08 졸업
- **한림대학교 소프트웨어융합학부 스마트 IOT 부전공 (3.0/4.5)** - 2025.08 졸업  
- **FastCampus x Upstage AI Bootcamp (이수중)** — 2026.05.29

---

## ✍ Goals to Focus
- **비즈니스 목적에 부합하는 최적의 AI 모델 아키텍처 설계 및 파이프라인 구축**
- **‘Garbage In, Garbage Out’ 원칙 기반, 철저한 탐색적 데이터 분석(EDA) 및 모델 관점의 정교한 전처리**
- **데이터 특성과 태스크의 본질을 고려하여, 명확한 논리적 근거에 기반한 최적의 평가 지표(Metric) 선정**
